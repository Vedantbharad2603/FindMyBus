<?php
    ...
    try {
        ...
        $querys = array("INSERT INTO findmybus.buses (BusNumber, BusType, TotalSeats, EngineNo, InsuranceNo)
                        ...
                        "INSERT INTO findmybus.users (userEmail, usernumber, userName)
                            VALUES
                            ('vedantbharad@gmail.com', '8780521033', 'vedant bharad'),
                            ('vedantbharad26@gmail.com', '8780521003', 'vedant h bharad');",
                        ...
                        "INSERT INTO findmybus.route (route_id, route_name, route_start_location, route_end_location,price)
                        VALUES 
                        (1, 'Ahmedabad-Mehsana Expressway', 'Ahmedabad', 'Mehsana',105),
                        (2, 'Surat-Baroda Highway', 'Surat', 'Vadodara',230),
                        (3, 'Rajkot-Jamnagar Highway', 'Rajkot', 'Jamnagar',137),
                        (4, 'Gujarat State Highway 68', 'Palanpur', 'Deesa',62),
                        (5, 'Ahmedabad-Rajkot Highway', 'Ahmedabad', 'Rajkot',321),
                        (6, 'Gujarat State Highway 41', 'Vadodara', 'Halol',51),
                        (7, 'Gujarat State Highway 151', 'Surat', 'Bardoli',51),
                        (8, 'Gujarat State Highway 6', 'Navsari', 'Vansda',45),
                        (9, 'Gujarat State Highway 141', 'Palitana', 'Amreli',183),
                        (10, 'Gujarat State Highway 25', 'Bhuj', 'Mandvi',90),
                        (11, 'Gujarat State Highway 20', 'Anand', 'Petlad',24),
                        (12, 'Gujarat State Highway 40', 'Bhavnagar', 'Talaja',39),
                        (13, 'Gujarat State Highway 72', 'Valsad', 'Dharampur',66),
                        (14, 'Gujarat State Highway 10', 'Junagadh', 'Somanath',123),
                        (15, 'Gujarat State Highway 33', 'Himmatnagar', 'Modasa',51),
                        (16, 'Gujarat State Highway 12', 'Godhra', 'Halol',42),
                        (17, 'Gujarat State Highway 64', 'Surendranagar', 'Dhrangadhra',41),
                        (18, 'Gujarat State Highway 13', 'Amreli', 'Savarkundla',56),
                        (19, 'Gujarat State Highway 5', 'Porbandar', 'Dwarka',161),
                        (20, 'Gujarat State Highway 163', 'Bharuch', 'Ankleshwar',23);",
