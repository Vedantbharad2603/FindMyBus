...
try {
    $querys = array("CREATE DATABASE IF NOT EXISTS $schema",
                ...
                "CREATE TABLE IF NOT EXISTS Tickets (
                    ...
                    userPhoneNo INT NOT NULL,
                    userAddarCardNo INT NOT NULL,
                    bookedSeats INT NOT NULL,
                    startlocation VARCHAR(20) NOT NULL,
                    endlocation VARCHAR(20) NOT NULL,
                    TripId VARCHAR(15),
                    FOREIGN KEY (TripId) REFERENCES busschedule(TripId)
                    );",
    );
    ...
    $querys = array("INSERT INTO `buses` (`BusNumber`, `Type`,`FualType`,`TotalSeats`, `EngineNo`, `InsuranceNo`)
                    ...
                    VALUES 
                        ...
                        ('Halol', 4, 'Near Surya Hotel' , 'Halol - Kalol Rd', 'Halol', 'Gujarat', '389350', '02676852369', '02676745896'),
                        ('Surendranagar', 3, 'Near Bus Station' , 'S T Road', 'Surendranagar', 'Gujarat', '363001', '02752124578', '02752745195'),
                    ...
                    VALUES
                        ...
                        ('DEGON001','Gondal', 'Depo','DEPO ADMIN','Gondal001'),
                        ('DEJET001','Jetpur', 'Depo','DEPO ADMIN','Jetpur001'),
                        ('DEPOR001','Porbandar', 'Depo','DEPO ADMIN','Porbandar001'),
                        ('DEVER001','Veraval', 'Depo','DEPO ADMIN','Veraval001'),
                        ('DENAV001','Navsari', 'Depo','DEPO ADMIN','Navsari001'),
                        ('DEKHE001','Kheda', 'Depo','DEPO ADMIN','Kheda001'),
                        ('DEKAP001','Kapadvanj', 'Depo','DEPO ADMIN','Kapadvanj001'),
                        ('DEHAL001','Halol', 'Depo','DEPO ADMIN','Halol001'),
                    ...
                    VALUES
                            ...
                            ('TRP003',1,5,NULL,'08:00:00'),
                            ('TRP003',2,1,'09:30:00','09:45:00'),
                            ('TRP003',3,11,'10:45:00','11:00:00'),
                            ('TRP003',4,12,'11:30:00','11:45:00'),
                            ('TRP003',5,3,'12:15:00','12:30:00'),
                            ('TRP003',6,10,'01:00:00','01:30:00'),
                            ('TRP003',7,6,'02:00:00',NULL),

                            ('TRP004',1,7,NULL,'08:00:00'),
                            ('TRP004',2,4,'09:30:00','09:45:00'),
                            ('TRP004',3,14,'10:45:00','11:00:00'),
                            ('TRP004',4,15,'11:30:00','11:45:00'),
                            ('TRP004',5,16,'12:15:00','12:30:00'),
                            ('TRP004',6,17,'01:00:00','01:30:00'),
                            ('TRP004',7,8,'02:00:00',NULL),

                            ('TRP005',1,9,NULL,'08:00:00'),
                            ('TRP005',2,1,'09:30:00','09:45:00'),
                            ('TRP005',3,6,'10:45:00','11:00:00'),
                            ('TRP005',4,11,'11:30:00','11:45:00'),
                            ('TRP005',5,3,'12:15:00','12:30:00'),
                            ('TRP005',6,12,'01:00:00','01:30:00'),
                            ('TRP005',7,10,'02:00:00',NULL),

                            ('TRP006',1,2,NULL,'08:00:00'),
                            ('TRP006',2,18,'09:30:00','09:45:00'),
                            ('TRP006',3,3,'10:45:00','11:00:00'),
                            ('TRP006',4,10,'11:30:00','11:45:00'),
                            ('TRP006',5,5,'12:15:00','12:30:00'),
                            ('TRP006',6,7,'01:00:00','01:30:00'),
                            ('TRP006',7,4,'02:00:00',NULL),

                            ('TRP007',1,1,NULL,'08:00:00'),
                            ('TRP007',2,12,'09:30:00','09:45:00'),
                            ('TRP007',3,11,'10:45:00','11:00:00'),
                            ('TRP007',4,19,'11:30:00','11:45:00'),
                            ('TRP007',5,20,'12:15:00','12:30:00'),
                            ('TRP007',6,21,'01:00:00','01:30:00'),
                            ('TRP007',7,3,'02:00:00',NULL),

                            ('TRP008',1,5,NULL,'08:00:00'),
                            ('TRP008',2,1,'09:30:00','09:45:00'),
                            ('TRP008',3,22,'10:45:00','11:00:00'),
                            ('TRP008',4,23,'11:30:00','11:45:00'),
                            ('TRP008',5,24,'12:15:00','12:30:00'),
                            ('TRP008',6,25,'01:00:00','01:30:00'),
                            ('TRP008',7,9,'02:00:00',NULL);",
                    "INSERT INTO busstatus (busid,currentDepo, delaytimeInminutes,availableSeat)
                    VALUES 
                            (1,1, 0,40),
                            (2,1, 0,30),
                            (3,1, 0,40),
