    ...
    <body>
        ...
        <div class="login-box">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
                ...
                <input type="number" id="NoOfPlatforms" name="NoOfPlatforms" style="padding: 12px 20px;border-radius: 4px;border: 1px solid #ccc;" onkeypress="return onlyNumber(event)" value="<?php echo $NoOfPlatforms; ?>" required>
                ...
                <input type="text" id="Address2" name="Address2" value="<?php echo $Address2; ?>" required>
                ...
                <input type="text" id="WorkMobileNo" name="WorkMobileNo" onkeypress="return onlyNumber(event)" value="<?php echo $WorkMobileNoErr; ?>" required>
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $DepoName1 = $_POST['DepoName'];
                $NoOfPlatforms1 = $_POST['NoOfPlatforms'];
                $Address11 = $_POST['Address1'];
                $Address22 = $_POST['Address2'];
                $City1 = $_POST['City'];
                $State1 = $_POST['State'];
                $PinCode1 = $_POST['PinCode'];
                $WorkMobileNo1 = $_POST['WorkMobileNo'];
                $SecondPhoneNo1 = $_POST['SecondPhoneNo'];
                $sql = "INSERT INTO depo (Name, NoOfPlatforms, Address1, Address2, City, State, PinCode, WorkPhoneNo, SecondPhoneNo)values(?,?,?,?,?,?,?,?,?)";
                if ($pdo->prepare($sql)->execute([$DepoName1,$NoOfPlatforms1,$Address11,$Address22,$City1,$State1,$PinCode1,$WorkMobileNo1,$SecondPhoneNo1])) {
                    unset($pdo);
